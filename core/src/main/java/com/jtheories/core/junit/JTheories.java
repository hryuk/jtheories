...
public class JTheories implements ParameterResolver {
    ...
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        return availableGenerators.stream().anyMatch(generatorType -> parameterContext.getParameter().getType().equals(generatorType));
    }
    ...
    public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
         Object generator = generators.
                stream()
                 .filter(gen -> {
                     try {
                         return gen.getClass().getDeclaredMethod("generate",SourceOfRandom.class).getReturnType().equals(parameterContext.getParameter().getType());
        ...
        try {
            ...
            throw new RuntimeException(String.format("Could not find generate() method on generator %s",generator.getClass().getName()));
        }
