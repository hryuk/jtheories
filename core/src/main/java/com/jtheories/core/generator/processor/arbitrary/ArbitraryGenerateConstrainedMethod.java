...
public class ArbitraryGenerateConstrainedMethod {
  ...
  public ArbitraryGenerateConstrainedMethod(
      ClassName returnType, List<MethodSpec> constrictorMethods) {
    ...
    this.constrainedMethod =
        MethodSpec.methodBuilder("generateConstrained")
            ...
            .addCode("\n")
            .addStatement(
                "$T<String, Object[]> methodParameters = new $T<>()", Map.class, HashMap.class)
