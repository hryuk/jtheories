...
public class ArbitraryGenerateBasicMethod {
	 ...
	 */
	public ArbitraryGenerateBasicMethod(
		GeneratorInformation information,
		...
		var generatedCode = this.generateCodeBlock(defaultMethod);
	...
	public MethodSpec getGenerateBasicMethod() {
